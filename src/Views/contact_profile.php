            ...
            <div class="card">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <p class="flex items-center">
                        <strong class="text-dynamic-secondary mr-2">Estado:</strong> 
                        <?php 
                            $estado = $contactDetails['estado_suscripcion'] ?? 'N/A';
                            $colorClass = 'bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400'; // Default
                            if ($estado == 'activo') $colorClass = 'bg-green-100 dark:bg-green-900/50 text-green-600 dark:text-green-400';
                            if ($estado == 'baja') $colorClass = 'bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-400';
                            if ($estado == 'rebotado_duro') $colorClass = 'bg-amber-100 dark:bg-amber-900/50 text-amber-600 dark:text-amber-400';
                        ?>
                        <span class="text-xs font-bold uppercase px-2.5 py-1 rounded-full <?= $colorClass ?>">
